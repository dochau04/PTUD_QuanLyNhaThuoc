...
CREATE TABLE ChiTietPhieuNhap (
    ...
    ghiChu NVARCHAR(100),
    PRIMARY KEY (maPhieuNhapKho, maThuoc, soLo), -- KHÓA CHÍNH KẾT HỢP ĐÚNG
    FOREIGN KEY (maPhieuNhapKho) REFERENCES PhieuNhapKho(maPhieuNhap),
    FOREIGN KEY (maThuoc, soLo) REFERENCES Thuoc(maThuoc, soLo) -- THAM CHIẾU ĐÚNG
);
...
CREATE TABLE ChiTietPhieuXuat (
    ...
    soLuong INT NOT NULL,
    ghiChu NVARCHAR(100),
    PRIMARY KEY (maPhieuXuatKho, maThuoc, soLo),
    FOREIGN KEY (maPhieuXuatKho) REFERENCES PhieuXuatKho(maPhieuXuat),
    FOREIGN KEY (maThuoc, soLo) REFERENCES Thuoc(maThuoc, soLo)
);
-- Bang KhuyenMai
...
('MTKS0001', 'Amoxicillin 500mg', 'LNKS00001', 'DV001', '2025-12-31', 5000, 200, 'LO124', 3000, '2022-01-01', N'Công ty TNHH United Pharma'),
('MTTH0001', 'Gastropulgite', 'LNTH00001', 'DV002', '2025-09-30', 80000, 40, 'LO102', 60000, '2022-04-05', N'Công ty Cổ phần Pymepharco');
...
('PN30102401001', '2025-03-30', 'NCC005', 'NV98001');

-- Thêm dữ liệu cho bảng ChiTietPhieuNhap
INSERT INTO ChiTietPhieuNhap (maPhieuNhapKho, maThuoc, soLo, soLuong, ghiChu)
VALUES 
('PN10012301001', 'MTKS0001', 'LO123', 200, N'Nhập đợt 1'),
('PN10012301001', 'MTGD0001', 'LO456', 50, N'Nhập đợt 1'),
('PN15122301001', 'MTVM0001', 'LO789', 50, N'Nhập đợt 2'),
('PN20032401001', 'MTTH0001', 'LO101', 80, N'Nhập đợt 3'),
('PN25102401001', 'MTDL0001', 'LO112', 60, N'Nhập đợt 4'),
('PN30102401001', 'MTKS0001', 'LO124', 250, N'Nhập đợt 5'),
('PN30102401001', 'MTTH0001', 'LO102', 60, N'Nhập đợt 5');
...
INSERT INTO ChiTietPhieuXuat (maPhieuXuatKho, maThuoc, soLo, soLuong, ghiChu)
VALUES 
('PX15012301001', 'MTKS0001', 'LO123', 50, N'Xuất bán'),
('PX15012301001', 'MTGD0001', 'LO456', 30, N'Xuất bán'),
('PX20122301001', 'MTVM0001', 'LO789', 20, N'Xuất bán'),
('PX25032401001', 'MTTH0001', 'LO101', 40, N'Xuất bán'),
('PX30102401001', 'MTDL0001', 'LO112', 25, N'Xuất bán');
...
/*UPDATE KhuyenMai
SET tenKhuyenMai = N'Khuyến mãi thành viên',
    ngayBatDau = '2024-07-01',
    ngayKetThuc = '2025-07-31',
    noiDungKhuyenMai = N'Giảm giá 15% cho thành viên vàng',
    trangThai = 1,
    giaTriKhuyenMai = 15
WHERE maKhuyenMai = 'KM0002';

UPDATE KhuyenMai
SET 
    tenKhuyenMai = N'Khuyến mãi đặc biệt',
    ngayBatDau = '2025-04-01',
    ngayKetThuc = '2025-04-30',  -- Sửa lại đúng năm
    noiDungKhuyenMai = N'Mua 2 tặng 1 cho sản phẩm vitamin',
    trangThai = 0,
    giaTriKhuyenMai = 50
WHERE maKhuyenMai = 'KM0005';
*/
